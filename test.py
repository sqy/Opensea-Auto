...
driver.find_element_by_id("password").send_keys(r"elysion0922")  #输入密码
...
driver.find_element_by_xpath('//*[@id="image"]').send_keys("D:\\Opensea-Auto\\u=2461535694,430498167&fm=26&gp=0.jpg")
driver.find_element_by_xpath('//*[@id="__next"]/div[1]/div/div/main/div/div/section[2]/div/div/div[5]/div/div/div/form/div[2]/div/div[1]/input').send_keys(r'123')
# 加名字重复情况处理
driver.find_element_by_xpath('//*[@id="__next"]/div[1]/div/div/main/div/div/section[2]/div/div/div[5]/div/div/div/form/div[3]/textarea').send_keys(r'123')